        ...
        <div className="flex flex-col items-end gap-2">
          {onInviteClick && (
            <button
              ...
              className="flex items-center gap-2.5 bg-gradient-to-b from-[#222222] to-[#151515] hover:from-[#2a2a2a] hover:to-[#1a1a1a] hover:-translate-y-[1px] text-[#ededed] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_2px_4px_rgba(0,0,0,0.4)] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] border-0 rounded-md px-4 h-8 text-[10px] font-mono uppercase tracking-[0.2em] focus:outline-none ring-0 w-full justify-center"
            >
          ...
          {isOwner && memberWorkloads.length > 1 && (
            <button
              ...
              className={cn(
                "flex items-center gap-2.5 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] border-0 rounded-md px-4 h-8 text-[10px] font-mono uppercase tracking-[0.2em] focus:outline-none ring-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_2px_4px_rgba(0,0,0,0.4)] w-full justify-center",
                revokeMode 
